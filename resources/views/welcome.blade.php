...
<body class="antialiased">
    <div
        class="containerBackground relative sm:flex sm:justify-center sm:items-center min-h-screen selection:bg-red-500 selection:text-white">
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            <div class="mt-16">
                <div class="grid grid-col md:grid-col gap-8 lg:gap-8">
                    @auth
                        <a href="{{ route('dashboard') }}"
                            ...
                            <div>
                                <div
                                    class="h-16 w-16 bg-amarillo flex items-center justify-center rounded-full">
                                ...
                                <h2 class="mt-6 text-xl font-semibold text-white"> Inicio </h2>
                    ...
                    @else
                        ...
                        <a href="{{ route('login') }}"
                            ...
                            <div>
                                <div class="h-16 w-16 bg-amarillo  flex items-center justify-center rounded-full">
                                    <img width="50" height="50" src="https://img.icons8.com/ios-filled/50/login-rounded-right.png" alt="login-rounded-right"/>
                                </div>

                                <h2 class="mt-6 text-xl font-semibold text-white">Accede </h2>
                        ...
                        <a href="{{ route('register') }}"
                            ...
                            <div>
                                <div class="h-16 w-16 bg-amarillo flex items-center justify-center rounded-full">
                                    <img width="48" height="48" src="https://img.icons8.com/sf-regular/48/000000/add-user-male.png" alt="add-user-male"/>
                                </div>

                                <h2 class="mt-6 text-xl font-semibold text-white">Registrate</h2>
