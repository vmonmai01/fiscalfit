<div class="bg-claro p-5 rounded-lg m-2">
    ...
    <div class="p-4">
        <p class="text-oscuro font-semibold text-2xl text-center" id="saldo_simulador">Saldo simulador:
            {{ number_format($user->simulator_balance, 2, '.', '') }}
            <span class="text-amarillo">€</span>
        </p>
        <button id="addSaldo" class="bg-green-600 hover:bg-green-800 text-white font-bold py-2 px-4 rounded" wire:click="addSaldo">
            Añadir saldo
        </button>
    </div>
    <script>
