    ...
    <form wire:submit.prevent="submit" class="bg-oscuro">
        <div class="p-4 rounded-lg max-w-sm">
            <div class="relative bg-inherit">
                ...
                <label for="amount"
                    class="absolute cursor-text left-0 -top-5 text-sm text-claro bg-inherit mx-1 px-1 peer-placeholder-shown:text-base peer-placeholder-shown:text-claro peer-placeholder-shown:top-2 peer-focus:-top-5 peer-focus:text-white peer-focus:text-sm transition-all">Importe
                    (€):
                </label>
            </div>
            @error('amount')
...
{{-- 
    <div class="bg-white p-4 rounded-lg max-w-sm">
        <div class="relative bg-inherit">
            ...
            <label for="username" class="absolute cursor-text left-0 -top-3 text-sm text-claro bg-inherit mx-1 px-1 peer-placeholder-shown:text-base peer-placeholder-shown:text-gray-500 peer-placeholder-shown:top-2 peer-focus:-top-3 peer-focus:text-sky-600 peer-focus:text-sm transition-all">Type inside me</label>
        </div>
    </div> 
