<div class="bg-oscuro rounded-lg p-8">
    <div class="bg-claro rounded-lg px-5 py-5">
        <h1 class="font-bold text-3xl text-oscuro text-center"> Listado de Usuarios </h1>
        <!-- Búsqueda -->
            ...
            <thead class="text-sm uppercase bg-medio text-gray-400">
                <tr>
                    ...
                    <th scope="col" class="px-6 py-3 tracking-wider">
                        ...
                        @if ($sortField == 'simulator_balance' && $sortAsc)
                            <span><i class="fa-solid fa-arrow-up-long fa-bounce" style="color: green;"></i></span>
                        @elseif($sortField == 'simulator_balance' && !$sortAsc)
                            <span><i class="fa-solid fa-arrow-down-long fa-bounce" style="color: red"></i></span>
                        @endif
                    </th>
                    <th scope="col" class="px-6 py-3 tracking-wider">
                            ...
                            <div class="flex flex-wrap">
                                <div class="w-1/3 p-4 flex items-center justify-center">
                                    ...
                                    <img src="{{ asset('storage/user_avatar/' . $userDetails->avatar) }}"
                                        alt="Avatar de {{ $userDetails->name }}"
