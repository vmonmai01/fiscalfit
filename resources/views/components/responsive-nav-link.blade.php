...
$classes = ($active ?? false)
            ? 'block w-full ps-3 pe-4 py-2 border-l-4 border-amarillo text-start text-base font-medium text-amarillo text-indigo-700  bg-indigo-50 focus:outline-none focus:text-indigo-800 focus:bg-indigo-100 focus:border-indigo-700  transition duration-150 ease-in-out'
