...
<body class="bg-gray-100">
    ...
    <div id="sidebarCollapsed"
        class="sidebar flex flex-col items-center w-16 h-full overflow-hidden text-gray-400 bg-gray-900 rounded">
    ...
    <div id="sidebarExpanded"
        class="sidebar hidden flex flex-col items-center w-40 h-full overflow-hidden text-gray-400 bg-gray-900 rounded">
        ...
        <div class="w-full px-2">
            ...
            <div class="flex flex-col items-center w-full mt-2 border-t border-gray-700">
                ...
                <a class="relative flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-700 hover:text-gray-300"
                    ...
                    <span class="absolute top-0 right-0 w-2 h-2 mt-2 mr-2 bg-indigo-500 rounded-full"></span>
                </a>
            </div>
            <a class="last-item flex items-center justify-center w-40 h-16  bg-gray-800 hover:bg-gray-700 hover:text-gray-300"
                href="#">
                <svg class="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none"
                    viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <script>
        ...
        toggleButtonCollapsed.addEventListener('click', () => {
            ...
            if (collapsedSidebar.classList.contains('hidden')) {
                // Por lo tanto, lo mostramos y ocultamos el sidebar expandido.
